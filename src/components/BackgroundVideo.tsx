        ...
        <div className="fixed inset-0 -z-20 bg-[#050505] overflow-hidden pointer-events-none select-none">
            ...
            >
                <video
                    ...
                    className={`object-cover w-full h-full grayscale-[0.3] brightness-110 contrast-105 opacity-100 mix-blend-normal transition-opacity duration-1000 ${videoLoaded ? 'opacity-100' : 'opacity-0'}`}
                >
                    <source src="/background.mp4" type="video/mp4" />
                </video>
            </motion.div>

            {/* Dark Overlay for text readability - Target 40-45% */}
            <div className="absolute inset-0 bg-black/45" />

            {/* Vignette - soft edges - Target 55-60% */}
